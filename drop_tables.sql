...
DROP TABLE "REPL_VALID_COMPAT" CASCADE CONSTRAINTS;
DROP TABLE "REPL_SUPPORT_MATRIX" CASCADE CONSTRAINTS;
DROP TABLE "SQLPLUS_PRODUCT_PROFILE" CASCADE CONSTRAINTS;
DROP TABLE "HELP" CASCADE CONSTRAINTS;
DROP TABLE "CONSERVATIONMETHODS" CASCADE CONSTRAINTS;
DROP TABLE "USERCONSERVATIONCHOICES" CASCADE CONSTRAINTS;
...
DROP TABLE "LOGMNRC_USER" CASCADE CONSTRAINTS;
